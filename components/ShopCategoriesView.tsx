    ...
    <Link href={category.href} className="group relative block w-full">
      <div className="relative overflow-hidden bg-border">
        <Image
          ...
          className="h-auto w-full object-contain grayscale contrast-[1.05] transition-[filter] duration-300 ease-out group-active:grayscale-0 group-active:contrast-100 md:group-hover:grayscale-0 md:group-hover:contrast-100"
          onError={() => {
        ...
        <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-black/50 via-transparent to-transparent opacity-85 transition-opacity duration-300 group-active:opacity-55 md:group-hover:opacity-55" />
        ...
        <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5">
          ...
          <p className="mt-1 text-[10px] uppercase tracking-[0.18em] text-white/80 opacity-70 transition-opacity duration-300 group-active:opacity-100 md:opacity-0 md:group-hover:opacity-100">
...
export function ShopCategoriesView({
  ...
  return (
    ...
    >
      <div className="px-4 py-12 text-center sm:px-6 sm:py-16 lg:px-8">
